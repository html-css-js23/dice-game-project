controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    if (controller.A.isPressed()) {
        timer.after(3500, function () {
            mySprite.sayText("This is your town hall")
        })
        timer.after(5000, function () {
            mySprite.sayText("You can return here to look at your stats")
        })
        timer.after(6500, function () {
            mySprite.sayText("and upgrade the town hall when needed")
        })
        timer.after(8000, function () {
            mySprite.sayText("Move around with the arrow keys.")
        })
        timer.after(9500, function () {
            mySprite.sayText("For your convenience we have seperated")
        })
        timer.after(11000, function () {
            mySprite.sayText("the city sections, to the left and up")
        })
        timer.after(12500, function () {
            mySprite.sayText("are the residential areas,")
        })
        timer.after(14000, function () {
            mySprite.sayText("downwards and to the right")
        })
        timer.after(15500, function () {
            mySprite.sayText("are the industrial and energy areas")
        })
        timer.after(17000, function () {
            mySprite.sayText("Remember, your goal is to get 100")
        })
        timer.after(18500, function () {
            mySprite.sayText("sustainability points")
        })
        timer.after(20000, function () {
            mySprite.sayText("with at least 50 of the other scores")
        })
        timer.after(21500, function () {
            mySprite.sayText("Have fun and enjoy!", 2000, false)
        })
    }
})
...
scene.setBackgroundImage(img`
    ...
    7777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777
    `)
mySprite.setPosition(58, 90)
mySprite.setScale(0.7, ScaleAnchor.Middle)
mySprite.sayText("\"Welcome to Sustainable City Builder.")
timer.after(1500, function () {
    mySprite.sayText("In this game you will learn everything there is to know about SDG 11")
})
timer.after(3500, function () {
    mySprite.sayText("To continue press A, want a detailed rulebook, visit:")
})
mySprite.sayText("")
